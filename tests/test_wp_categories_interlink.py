    ...
    def test_wp_categories_infer_sovety_from_sleeping_places_brief(self) -> None:
        ...
        try:
                ...
                json.dumps(
                    {
                        ...
                        "topic_id": "B25",
                        "title": "Fixture sleeping places brief",
                    },
                    ensure_ascii=False,
                )
                + "\n",
            ...
            (article_dir / "title-brief.json").write_text(
                json.dumps(
                    {
                        "subject": "Несоответствие спальных мест в посуточной квартире в Тюмени",
                        "angle": "Две кровати в карточке оказались одной кроватью, диваном и складным матрасом",
                    },
                    ensure_ascii=False,
                )
                + "\n",
