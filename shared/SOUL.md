...
10. **Dzen-excerpt:** первый экран = карточка Дзена (крючок + takeaway); обещание H1 выполнено в теле.
11. **Обложка:** wow-постер, тёплая квартира, одна подпись; без CAPS-стен, красных стрелок, «ТОП-10 СЕКРЕТОВ»; логотип только PNG-overlay.
