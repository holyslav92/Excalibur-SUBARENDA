...
- Upload transport: **FTP passive port 21** (Timeweb) локально; **Cloud Agent** — при PASV data timeout авто-fallback SFTP:22. Ручной override: `FTP_TRANSPORT=sftp FTP_PORT=22`.
