...
4. После сырьевых блоков вызывай Task:
   - `Task(excalibur-blog-setup-voice)`
   - `Task(excalibur-blog-setup-visual)`
...
`Task(excalibur-blog-setup-voice)` с полным контекстом.
