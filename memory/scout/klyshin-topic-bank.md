...
| 22.09 | B32 | `checkout_price_stack` | ✅ B32 handoff 2026-09-22 — цена за ночь vs итог на оплате (+12% + уборка); P0 «квартиры посуточно тюмень» 4409 |
...
| `utilities_jkh` | «Коммуналка включена» — на выезде счёт 1 840 ₽ по счётчикам | Что входит в цену до брони; NOT B10 такси, NOT B12 кран | квартиры посуточно тюмень / коммунальные аренда |
| `checkout_price_stack` | 3 400 ₽/ночь в карточке → 8 816 ₽ на оплате | Сервис + уборка на шаге оплаты; контраст с отелем; NOT код/залог | комиссия посуточно / квартиры посуточно тюмень |
