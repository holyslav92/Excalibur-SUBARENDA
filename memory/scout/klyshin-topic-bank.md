...
|---------------|---------|---------|-------|
| 26–28.08 | 1 | `parents_sept_uni` | Родители 1 сентября — **saturated live 25.08** |
| 29–31.08 | 2 | `sept_business_trip` | **B03 handoff 25.08** — стол, розетки, Wi‑Fi, закрывающие; P0 «квартиры посуточно тюмень» 5875 |
...
| 08–10.09 | 8 | `checkout_train_bags` | Выезд в 12:00 + поезд днём: куда деть чемоданы |
